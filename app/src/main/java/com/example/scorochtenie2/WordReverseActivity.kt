...
class WordReverseActivity : AppCompatActivity() {
    private lateinit var textView: TextView
    private lateinit var guideView: View
    private lateinit var timerView: TextView
    private val technique: Technique = WordReverseTechnique()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val techniqueName = intent.getStringExtra("technique_name") ?: "Слова наоборот"
    ...
    override fun onDestroy() {
        ...
        technique.cancelAnimation()
        stopTimer()
        saveTime(intent.getStringExtra("technique_name") ?: "Слова наоборот", System.currentTimeMillis() - startTime)
    }

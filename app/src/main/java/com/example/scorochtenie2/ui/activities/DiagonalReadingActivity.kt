...
class DiagonalReadingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView = findViewById(R.id.diagonal_text_view)
    ...
    override fun onDestroy() {
        ...
        technique.cancelAnimation()
        stopTimer()
        saveTime(intent.getStringExtra("technique_name") ?: "Чтение по диагонали", System.currentTimeMillis() - startTime)
    }
